...
public class BoardDao {
	...
	*======================================================================*/
	...
	private Connection getConnection() throws Exception{
		...
		DataSource ds = (DataSource) envCtx.lookup("jdbc/root");//3. 자원들 중 원하는 jdbc/jskim 자원을 찾아내어 데이터소스를 가져옴
	...
	public void insert(BoardDto dto) {
		String sql = "INSERT INTO board(ID, PWD, NAME, EMAIL) VALUES(?, ?, ?, ?)";
	...
	public ArrayList<BoardDto> list(){
		String sql = "SELECT BCODE, ID, PWD, NAME, EMAIL FROM board order by bcode desc";
	...
	public void update(BoardDto dto) {
		String sql = "UPDATE board SET id = ?, pwd = ?, name = ?, email = ? WHERE bcode =?";
